...
Apply systematic debugging: scientific method, isolation techniques, and profiling tools with proven strategies, powerful tools, and methodical approaches.
...
- Use imperative: Investigate environment differences when behavior varies
...
Either create the reference files or remove the Resources section entirely
